<template>
  <div class="about">
    ...
    <p>You can change or remove your topics on <router-link :to="PageIDs.SUBSCRIPTION">subscription</router-link> page and every email has a one-click unsubscribe link.</p>
    ...
    <h3>Feedback</h3>
    <p>Your feedback is very welcome. The best way to get in touch is to <a href="mailto:max@bitesized.info">email the developer</a>.</p>
