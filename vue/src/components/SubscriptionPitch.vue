  ...
  <div>
    <div class="flex">
      ...
      <div class="mt-4 card flex-grow md:flex-shrink">
        <h3 class="text-justify md:text-center text-slate-700">2 minutes per day if you know the answer, 5 - 10 minutes if you don't</h3>
        <ul id="signup-pitch">
          <li><i class="pi pi-question-circle"></i>one question per email</li>
          <li><i class="pi pi-envelope"></i>sent daily to <strong>{{ store.email }}</strong> </li>
          <li><i class="pi pi-pause-circle"></i>paused automatically if you get a backlog</li>
          <li><i class="pi pi-ban"></i>every email includes an unsubscribe link</li>
        </ul>

        <div class="my-12 mx-auto text-center">
          <figure class="max-w-screen-md mx-auto">
            <svg class="h-8 mx-auto mb-3 text-slate-400" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <figcaption class="flex items-center justify-center mt-6 space-x-3">
              ...
              <div class="flex items-center divide-x-2 divide-slate-500 text-slate-500">
