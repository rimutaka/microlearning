<template>
  <div class="mb-8 cta-box">
    <h1 class="mb-4 md:mb-8 text-slate-700 dark:text-slate-100 w-full">Find and fill gaps in your knowledge,<br/>one question at a time</h1>

    <div class="flex w-full">
      <div class="flex-shrink md:flex-grow">
      </div>

      <div class="card flex-grow md:flex-shrink md:mb-8 text-slate-600 dark:text-slate-200">
        <ul id="signup-pitch">
